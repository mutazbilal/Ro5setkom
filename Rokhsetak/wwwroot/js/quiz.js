    ...
    function bindSubmitLock() {
        ...
        forms.forEach(function (form) {
            form.addEventListener('submit', function (e) {
                ...
                // ✅ IMPORTANT: only lock if form is valid
                // This respects required fields (radio groups, etc.)
                if (!form.checkValidity()) {
                    return; // let browser handle validation UI
                }
                ...
                if (labelEl) {
                    labelEl.textContent =
                        labelEl.dataset.loadingText || 'Submitting…';
                }
            });
        });
    }
