...
{
    // Listing / details
    Task<ServiceResult<MentorListViewModel>> GetMentorsAsync(MentorListFilter filter);
    Task<ServiceResult<MentorDetailViewModel>> GetMentorDetailsAsync(int mentorId);

    // Applications
    Task<ServiceResult<MentorApplicationListViewModel>> GetPendingApplicationsAsync();
    Task<ServiceResult<MentorApplicationDetailViewModel>> GetApplicationDetailsAsync(int applicationId);
