...
DB_ROOT = Path(r"C:\Users\Lenovo\source\repos\Rokhsetak\RokhsetakDB")

RUN_ALL_FILE = DB_ROOT / "RunAll.sql"

CREATE_OUTPUT = DB_ROOT / "CreateDatabase.sql"
SEED_OUTPUT = DB_ROOT / "SeedDatabase.sql"
...
def main():
    ...
    runall_content = RUN_ALL_FILE.read_text(encoding="utf-8")
