...
VALUES (
    1,  -- assumes sequential execution
    'en',
...
VALUES (
    1,  -- using module_id for simplicity, adjust if needed
    'ar',
...
VALUES (
    2,  -- assumes sequential execution
    'en',
...
VALUES (
    2,  -- using module_id for simplicity, adjust if needed
    'ar',
...
VALUES (
    3,  -- assumes sequential execution
    'en',
...
VALUES (
    3,  -- using module_id for simplicity, adjust if needed
    'ar',
...
VALUES (
    4,  -- assumes sequential execution
    'en',
...
VALUES (
    4,  -- using module_id for simplicity, adjust if needed
    'ar',
...
VALUES (
    5,  -- assumes sequential execution
    'en',
...
VALUES (
    5,  -- using module_id for simplicity, adjust if needed
    'ar',
...
VALUES (
    6,  -- assumes sequential execution
    'en',
...
VALUES (
    6,  -- using module_id for simplicity, adjust if needed
    'ar',
...
VALUES (
    7,  -- assumes sequential execution
    'en',
...
VALUES (
    7,  -- using module_id for simplicity, adjust if needed
    'ar',
...
VALUES (
    8,  -- assumes sequential execution
    'en',
...
VALUES (
    8,  -- using module_id for simplicity, adjust if needed
    'ar',
...
VALUES (
    9,  -- assumes sequential execution
    'en',
...
VALUES (
    9,  -- using module_id for simplicity, adjust if needed
    'ar',
...
VALUES (
    10,  -- assumes sequential execution
    'en',
...
VALUES (
    10,  -- using module_id for simplicity, adjust if needed
    'ar',
...
VALUES (
    11,  -- assumes sequential execution
    'en',
...
VALUES (
    11,  -- using module_id for simplicity, adjust if needed
    'ar',
...
VALUES (
    12,  -- assumes sequential execution
    'en',
...
VALUES (
    12,  -- using module_id for simplicity, adjust if needed
    'ar',
...
VALUES (
    13,  -- assumes sequential execution
    'en',
...
VALUES (
    13,  -- using module_id for simplicity, adjust if needed
    'ar',
...
VALUES (
    14,  -- assumes sequential execution
    'en',
...
VALUES (
    14,  -- using module_id for simplicity, adjust if needed
    'ar',
...
VALUES (
    15,  -- assumes sequential execution
    'en',
...
VALUES (
    15,  -- using module_id for simplicity, adjust if needed
    'ar',
...
VALUES (
    16,  -- assumes sequential execution
    'en',
...
VALUES (
    16,  -- using module_id for simplicity, adjust if needed
    'ar',
...
VALUES (
    17,  -- assumes sequential execution
    'en',
...
VALUES (
    17,  -- using module_id for simplicity, adjust if needed
    'ar',
...
VALUES (
    18,  -- assumes sequential execution
    'en',
...
VALUES (
    18,  -- using module_id for simplicity, adjust if needed
    'ar',
...
VALUES (
    19,  -- assumes sequential execution
    'en',
...
VALUES (
    19,  -- using module_id for simplicity, adjust if needed
    'ar',
...
VALUES (
    20,  -- assumes sequential execution
    'en',
...
VALUES (
    20,  -- using module_id for simplicity, adjust if needed
    'ar',
...
VALUES (
    21,  -- assumes sequential execution
    'en',
...
VALUES (
    21,  -- using module_id for simplicity, adjust if needed
    'ar',
...
VALUES (
    22,  -- assumes sequential execution
    'en',
...
VALUES (
    22,  -- using module_id for simplicity, adjust if needed
    'ar',
...
VALUES (
    23,  -- assumes sequential execution
    'en',
...
VALUES (
    23,  -- using module_id for simplicity, adjust if needed
    'ar',
...
VALUES (
    24,  -- assumes sequential execution
    'en',
...
VALUES (
    24,  -- using module_id for simplicity, adjust if needed
    'ar',
...
VALUES (
    25,  -- assumes sequential execution
    'en',
...
VALUES (
    25,  -- using module_id for simplicity, adjust if needed
    'ar',
...
VALUES (
    26,  -- assumes sequential execution
    'en',
...
VALUES (
    26,  -- using module_id for simplicity, adjust if needed
    'ar',
...
VALUES (
    27,  -- assumes sequential execution
    'en',
...
VALUES (
    27,  -- using module_id for simplicity, adjust if needed
    'ar',
...
VALUES (
    28,  -- assumes sequential execution
    'en',
...
VALUES (
    28,  -- using module_id for simplicity, adjust if needed
    'ar',
...
VALUES (
    29,  -- assumes sequential execution
    'en',
...
VALUES (
    29,  -- using module_id for simplicity, adjust if needed
    'ar',
...
VALUES (
    30,  -- assumes sequential execution
    'en',
...
VALUES (
    30,  -- using module_id for simplicity, adjust if needed
    'ar',
