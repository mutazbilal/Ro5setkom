...
INSERT INTO Learning.QuestionTranslations (question_id, language_code, question_text) VALUES (11, 'en', N'[Insert picture of solid yellow line on driver''s side] What does this line mean for you?');
INSERT INTO Learning.QuestionTranslations (question_id, language_code, question_text) VALUES (11, 'ar', N'[أدخل صورة الخط الأصفر الثابت على جانب السائق] ماذا يعني هذا الخط بالنسبة لك؟');
...
INSERT INTO Learning.QuestionTranslations (question_id, language_code, question_text) VALUES (15, 'en', N'[Insert picture of zebra crossing with zigzag lines] What is the maximum speed limit when approaching this road marking?');
INSERT INTO Learning.QuestionTranslations (question_id, language_code, question_text) VALUES (15, 'ar', N'[أدخل صورة عبور الحمار الوحشي بخطوط متعرجة] ما هو الحد الأقصى للسرعة عند الاقتراب من علامة الطريق هذه؟');
...
INSERT INTO Learning.QuestionTranslations (question_id, language_code, question_text) VALUES (21, 'en', N'[Insert picture of red-bordered inverted triangle sign] What does this sign require you to do?');
INSERT INTO Learning.QuestionTranslations (question_id, language_code, question_text) VALUES (21, 'ar', N'[أدخل صورة علامة المثلث المقلوب ذات الحدود الحمراء] ما الذي تتطلب منك هذه العلامة أن تفعله؟');
...
INSERT INTO Learning.QuestionTranslations (question_id, language_code, question_text) VALUES (23, 'en', N'Scenario: You are driving on a narrow mountain road and see [Insert picture of red circle with red arrow pointing up and black arrow pointing down]. What does this mean?');
INSERT INTO Learning.QuestionTranslations (question_id, language_code, question_text) VALUES (23, 'ar', N'السيناريو: أنت تقود سيارتك على طريق جبلي ضيق وانظر [أدخل صورة لدائرة حمراء مع سهم أحمر يشير إلى الأعلى وسهم أسود يشير إلى الأسفل]. ماذا يعني هذا؟');
INSERT INTO Learning.QuestionTranslations (question_id, language_code, question_text) VALUES (24, 'en', N'[Insert picture of yellow diamond sign with white border] What does this sign indicate?');
INSERT INTO Learning.QuestionTranslations (question_id, language_code, question_text) VALUES (24, 'ar', N'[أدخل صورة علامة الماسة الصفراء ذات الحدود البيضاء] إلى ماذا تشير هذه العلامة؟');
...
INSERT INTO Learning.QuestionTranslations (question_id, language_code, question_text) VALUES (29, 'en', N'[Insert picture of blue square sign with white arrow pointing down and red arrow pointing up] What does this sign tell you?');
INSERT INTO Learning.QuestionTranslations (question_id, language_code, question_text) VALUES (29, 'ar', N'[أدخل صورة للعلامة المربعة الزرقاء مع سهم أبيض يشير إلى الأسفل وسهم أحمر يشير إلى الأعلى] ماذا تخبرك هذه العلامة؟');
